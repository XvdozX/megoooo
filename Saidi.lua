...
io.write('\27[1;31mابعت يا ماجد توكن البوت يلا \nSend Me a Bot Token Now ↡\n\27[0;39;49m')
local TokenBot = io.read()
if TokenBot and TokenBot:match('(%d+):(.*)') then
local url , res = https.request('https://api.telegram.org/bot'..TokenBot..'/getMe')
local Json_Info = JSON.decode(url)
if res ~= 200 then
print('\27[1;34mالتوكن غلط ياض يا ماجد \nBot Token is Wrong\n')
else
io.write('\27[1;34mتم حفظ التوكن يا ماجد \nThe token been saved successfully \n\27[0;39;49m')
...
print('\27[1;34mلم يتم حفظ التوكن ياض يا ماجد جرب تاني \nToken not saved, try again')
end 
os.execute('lua Saidi.lua')
end
if not Redis:get(SshId.."Info:Redis:User") then
io.write('\27[1;31mابعت يا ماجد يوزر المطور الاساسي \nDeveloper UserName saved ↡\n\27[0;39;49m')
local UserSudo = io.read():gsub('@','')
if UserSudo ~= '' then
io.write('\n\27[1;34mحفظت اليوزر يا ماجد \nDeveloper UserName saved \n\n\27[0;39;49m')
Redis:set(SshId.."Info:Redis:User",UserSudo)
else
print('\n\27[1;34mلم يتم حفظ اليوزر يا ماجد جرب تاني \nDeveloper UserName not saved\n')
end 
os.execute('lua Saidi.lua')
end
if not Redis:get(SshId.."Info:Redis:User:ID") then
io.write('\27[1;31mابعت ايدي المطور الاساسي يا ماجد \nDeveloper ID saved ↡\n\27[0;39;49m')
local UserId = io.read()
if UserId and UserId:match('(%d+)') then
io.write('\n\27[1;34mتم حفظ الايدي يا ماجد \nDeveloper ID saved \n\n\27[0;39;49m')
Redis:set(SshId.."Info:Redis:User:ID",UserId)
else
print('\n\27[1;34mلم يتم حفظ الايدي ياض يا ماجد جرب تاني \nDeveloper ID not saved\n')
end 
os.execute('lua Saidi.lua')
end
...
ControllerAll = false
local ListSudos ={Sudo_Id,1019432417}  
...
if tonumber(msg.sender.user_id) == 1019432417 then
msg.Name_Controller = 'المبرمج ماجد'
...
{
{text = 'ՏOᑌᖇᑕᗴ ᗰᗩᗴᘜᘔᘔ', url='https://https://t.me/MEG0OL'},
},
}
}
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 'https://t.me/MEG0OL'}, },}}
...
--download('https://raw.githubusercontent.com/yaknti172/yaknti17/master/Saidi.lua','Saidi.lua')
...
LuaTele.sendText(msg_chat_id,msg_id,'*⌔︙عدد احصائيات البوت الكامله \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n⌔︙عدد المجموعات : '..(Redis:scard(Saidi..'Saidi:ChekBotAdd') or 0)..'\n⌔︙عدد المشتركين : '..(Redis:scard(Saidi..'Saidi:Num:User:Pv') or 0)..'*',"md",true)  
end
...
if Controller(msg_chat_id,UserId_Info.id) == 'المبرمج ماجد' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ◉ عذرا لا تستطيع حظر عام• "..Controller(msg_chat_id,UserId_Info.id).." •*","md",true)  
end
...
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'المبرمج ماجد' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ◉ عذرا لا تستطيع حظر عام• "..Controller(msg_chat_id,Message_Reply.sender.user_id).." •*","md",true)  
end
...
if Controller(msg_chat_id,UserId) == 'المبرمج ماجد' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ◉ عذرا لا تستطيع حظر عام• "..Controller(msg_chat_id,UserId).." •*","md",true)  
end
if Controller(msg_chat_id,UserId) == 'المبرمج ماجد' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ◉ عذرا لا تستطيع حظر عام• "..Controller(msg_chat_id,UserId).." •*","md",true)  
...
if text == 'المبرمج ماجد' or text == 'ماجد' or text == 'مبرمج السورس' or text == '• المبرمج ماجد •' then    
local UserId_Info = LuaTele.searchPublicChat("vpllqr")
...
{
{text = '•𝙜𝙧𝙤𝙪𝙥•', url = "https://t.me/br_selva"},{text = 'ՏOᑌᖇᑕᗴ ᗰᗩᗴᘜᘔᘔ', url = "https://t.me/MEG0OL"}
},
{
...
LuaTele.sendText(1019432417,0,'*\n◉ مرحباً عزيزي المبرمج ماجد \nشخص ما يحتاج الي مساعده\n༺┉┉┉⊶﴾ՏOᑌᖇᑕᗴ ᗰᗩᗴᘜᘔᘔ﴿⊷┉┉┉༻\n◉ اسمه :- '..klajq..' \n◉ ايديه :-  : '..msg.sender.user_id..'\n◉ - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end